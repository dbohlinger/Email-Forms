        ...
        var newIn =     '<div id="field'+ next +'" name="field'+ next +'"> '+
                        '<!-- Text input-->'+
                            '<div class="form-group" row>'+
                                '<label class="col-md-4 control-label" for="action_id">Charge Description</label> '+
                                '<div class="col-md-5">'+
                            ...
                            '<div class="form-group"> '+
                                '<label class="col-md-4 control-label" for="action_name">Orignal</label> '+
                                '<div class="col-md-5"> '+
                                    '<input id="action_name" name="action_name" type="text" placeholder="" class="form-control input-md"> '+
                                '</div>'+
                                '<label class="col-md-4 control-label" for="action_name">Corrected</label> '+
                                '<div class="col-md-5"> '+
                                    '<input id="action_name" name="action_name" type="text" placeholder="" class="form-control input-md"> '+
                                '</div>'+
                            '</div><br><br>'+
