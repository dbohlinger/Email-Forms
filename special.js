...
function sendMail() {
   var link = "mailto:dylanb@lynden.com"
                ...
                + "custName : " + escape(document.getElementById('custName').value) + "%0A" + "%0A"
                ...
                + "tel : " + escape(document.getElementById('tel').value) + "%0A" + "%0A"
                + "fax : " + escape(document.getElementById('fax').value) + "%0A" + "%0A"
                + "sales : " + escape(document.getElementById('sales').value) + "%0A" + "%0A"
                + "control : " + escape(document.getElementById('control').value) + "%0A" + "%0A"
                + "tariff : " + escape(document.getElementById('tariff').value) + "%0A" + "%0A"
                + "specialdir : " + escape(document.getElementById('specialdir').value) + "%0A" + "%0A"
                ;
